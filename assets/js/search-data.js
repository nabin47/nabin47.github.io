      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-research-recognition-miyan-publications-reward-2026",
          title: 'Research Recognition – Miyan Publications Reward 2026',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_2/";
            },},{id: "news-acceptance-peccii-2026",
          title: 'Acceptance – PECCII 2026',
          description: "",
          section: "News",handler: () => {
              window.location.href = "/news/announcement_3/";
            },},{id: "news-publication-in-ieee-xplore-icmi-2025-proceedings",
          title: 'Publication in IEEE Xplore – ICMI 2025 Proceedings',
          description: "",
          section: "News",handler: () => {
          ...
          section: "Teachings",handler: () => {
            ...
            },},{id: "teachings-computer-vision-and-image-processing",
          ...
          section: "Teachings",handler: () => {
              window.location.href = "/teachings/system-analysis-and-design/";
            },},{
        id: 'social-cv',
        title: 'CV',
        section: 'Socials',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%68%6D%65%64.%63%73%65@%69%75%62%61%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/ahmednabin", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Rnh7FmQAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
